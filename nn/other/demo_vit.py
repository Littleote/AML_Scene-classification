...
#         self.conv1 = nn.Conv2d(in_channels=3, out_channels=16, kernel_size=3, padding=1)  # 3 input channels
...
class UrbanSceneResNet(nn.Module):
    def __init__(self, num_classes=6):
        super(UrbanSceneResNet, self).__init__()
