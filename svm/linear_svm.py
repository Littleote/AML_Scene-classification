...
if __name__ == "__main__":
    ...
    df_1 = grid_search(X, y, verbose=True, transformation="none", kernel="linear")
    df_2 = grid_search(X_root4, y, verbose=True, transformation="root 4", kernel="linear")
    df_3 = grid_search(X_lowdim, y, verbose=True, transformation="PaCMAP", kernel="linear")
